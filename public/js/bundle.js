...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHVza3lkZXYiLCJhIjoiY2wydWJsbzU0MDBnOTNwamoyNDE5NmdldyJ9.AfCqE_FtceoORdbZpO3WKQ';
...
exports.executeIn = void 0;

var executeIn = function executeIn(s, fn) {
  setTimeout(function () {
    fn();
  }, s * 1000);
};

exports.executeIn = executeIn;
...
var hideAlert = function hideAlert() {
  // Select alert
  var el = document.querySelector('.alert'); // Hide it, if alert exists
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert(); // Make a new alert for our response

  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  (0, _utils.executeIn)(5, hideAlert);
};

exports.showAlert = showAlert;
},{"./utils":"utils.js"}],"login.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _utils.executeIn)(1.5, location.assign('/'));
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('ongoing', 'Logging you out..');
              location.reload();
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./utils":"utils.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(action),
              data: data
            });
...
var userPasswordForm = document.querySelector('.form-user-password'); // HEADER - LOGOUT
